...
function getComponentsFiles() {
  ...
  // Добавим wow.js
  if(fileExistAndHasContent(dirs.source + '/js/wow.js')) {
    сomponentsFilesList.js.unshift(dirs.source + '/js/wow.js');
  }  
  // Добавим jquery.circlechart.js
  ...
  // Добавим owl.carousel.js
  if(fileExistAndHasContent(dirs.source + '/js/owl.carousel.js')) {
    сomponentsFilesList.js.unshift(dirs.source + '/js/owl.carousel.js');
  }    
